...
#This sets the logging error and default. The Default is 'Warning'.
...
def open_input():
    try:
       with open(args.filename) as file_object:
        ...
        logging.warning("Error{}.  Sorry the file could not be found, check and try again".format(e))
...
def translate_text(**kwargs):
    try:
        ...
        logging.warning("Botocore generated as error {}".format(e))
...
def translate_loop():
    try:
        ...
        logging.warning("translation failed, check logs for details")
